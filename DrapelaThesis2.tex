...
\input{src/Metody_odhadu}
\input{src/Physical_model}
\input{src/Detection}
\input{src/StoneParameters}
\input{src/ShiftOfRays}
\input{src/Terminologie}
\input{src/Optimization_intro}
\input{src/Korespondence}
\input{src/Param_experinents}
\input{src/AutoAlg}
\input{src/Separability}
\input{src/Results}
